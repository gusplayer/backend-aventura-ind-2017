...
<html lang="es">
	...
	<body style="margin:0px;">
		<div class="content2 Oculto1">
			<a href="../test/2" class="intro" style="position: relative"><img src="../mig/images/mapa2/test_fondo2.jpg"></a>			
		</div>

		<div class="content3 Oculto1"  style="display:none;">
			<a href="../test/2" class="intro" style="position: absolute;z-index: 400;top: 0px;"><img src="../mig/images/mapa2/test_fondo21.jpg"></a>
		</div>
		<div class="content4 Oculto1"  style="display:none;">
			<a href="../test/2" class="intro" style="position: absolute;z-index: 500;top: 0px;"><img src="../mig/images/mapa2/test_fondo22.jpg"></a>
		</div>

		<div class="content5 Mostrar1">
			<a href="../test/2" style="position: relative"><img src="../mig/images/mapa2/test_fondo2m.jpg"></a>	
		</div>
